  ...
  render() {
    ...
    return (
      ...
      >
        ...
        <div role="search" className={cx({ element: 'wrapper' })}>
          <input
            ...
            onBlur={this.onBlur}
            className={cx({ element: 'input' })}
          />
          <button
            type="submit"
            title={translate('submitTitle')}
            className={cx({ element: 'submit' })}
          >
            {submitComponent}
          </button>
          <button
...
const SearchBoxComponent = translatable({
