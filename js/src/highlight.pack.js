...
!(function(e) {
  ...
  function c(e, r, a) {
    ...
    for (var l = 0, s = '', f = []; e.length || r.length; ) {
      ...
      if (((s += n(a.substring(l, g[0].offset))), (l = g[0].offset), g === e)) {
        ...
        'start' === g[0].event ? f.push(g[0].node) : f.pop(), c(
          g.splice(0, 1)[0]
        );
    }
    ...
    function r(a, i) {
      if (!a.compiled) {
        ...
        (a.lR = t(a.l || /\w+/, !0)), i &&
          ...
          ), a.i && (a.iR = t(a.i)), null == a.r && (a.r = 1), a.c ||
          (a.c = []), (a.c = Array.prototype.concat.apply(
          [],
          a.c.map(function(e) {
            return l('self' === e ? a : e);
          })
  ...
  function f(e, t, a, i) {
    ...
    function h() {
      ...
      for (a = '', t = 0, E.lR.lastIndex = 0, r = E.lR.exec(k); r; )
        (a += n(k.substring(t, r.index))), (e = l(E, r)), e
          ? ((B += e[1]), (a += p(e[0], n(r[0]))))
          : (a += n(r[0])), (t = E.lR.lastIndex), (r = E.lR.exec(k));
    ...
    function d() {
      ...
      return E.r > 0 &&
        (B += t.r), e && (x[E.sL] = t.top), p(t.language, t.value, !1, !0);
    }
    function b() {
      (L += null != E.sL ? d() : h()), (k = '');
    }
    ...
    function m(e, n) {
      ...
      if (t)
        return t.skip
          ? (k += n)
          : (t.eB && (k += n), b(), t.rB || t.eB || (k = n)), v(t, n), t.rB
          ? 0
          : n.length;
      var r = u(E, n);
      if (r) {
  ...
  function h(e, n, t) {
    ...
    return e.match(/\bhljs\b/) ||
      a.push('hljs'), -1 === e.indexOf(r) && a.push(r), a.join(' ').trim();
  }
  function d(e) {
    var n,
      t,
